...
namespace AnySilkBoss.Source.Behaviours.Memory
{
    ...
    internal class MemoryFingerBladeBehavior : MonoBehaviour
    {
        ...
        private void AddOrbitStartActions(FsmState orbitStartState)
        {
            ...
            var orbitAction = new MemoryFingerBladeOrbitAction
            {
        ...
        private void CreatePhase2TrackState()
        {
            ...
            // 追踪玩家
            var trackAction = new MemoryFingerBladeTrackAction
            {
                targetX = null,
                targetY = null,
        ...
        public void SpawnAndFirePin()
        {
            ...
            {
                Log.Warn($"[MemoryFingerBlade {bladeIndex}] FirstWeaverManager 未就绪，跳过 Pin 发射");
                return;
            }
    ...
    /// </summary>
    public class MemoryFingerBladeOrbitAction : FsmStateAction
    {
        [Header("环绕参数")]
    ...
    /// </summary>
    public class MemoryFingerBladeTrackAction : FsmStateAction
    {
