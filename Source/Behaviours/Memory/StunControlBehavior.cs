...
namespace AnySilkBoss.Source.Behaviours.Memory
{
    ...
    /// 负责管理Boss的晕眩状态和行为
    /// </summary>
    internal class MemoryStunControlBehavior : MonoBehaviour
    {
        // FSM引用
        ...
        private void ModifyStunBehavior()
        {
            ...
            // ========== 在这里添加你的晕眩修改逻辑 ==========
            _stunControl.FsmVariables.GetFsmInt("Stun Combo").Value = 6666;
            _stunControl.FsmVariables.GetFsmInt("Stun Hit Max").Value = 8888;
        }
